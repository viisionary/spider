...
export const tileData = [
    {
        img: formExample,
        title: 'Media EXAMPLE & DOC',
        author: 'visionary',
        path: MEDIAS,
    },
    {
        img: formExample,
        title: 'socket.io EXAMPLE & DOC',
        author: 'visionary',
        path: SOCKET,
    },
    {
        img: formExample,
        title: '表单 EXAMPLE & DOC',
        author: 'visionary',
        path: '/form',
    },
    {
        img: formExample,
        title: '分页列表 EXAMPLE & DOC',
        author: 'visionary',
        path: '/listPages',
    },
    {
        img: formExample,
        title: '流式列表 EXAMPLE & DOC',
        author: 'visionary',
        path: '/lists',
    },
    {
        img: formExample,
        title: '详情 EXAMPLE & DOC',
        author: 'visionary',
        path: '',
    },
    {
        img: formExample,
        title: '主题切换 EXAMPLE & DOC',
        author: 'visionary',
        path: '/theme',
        showIndex: true,
    },
    {
        img: formExample,
        title: '布局 EXAMPLE & DOC',
        author: 'visionary',
        path: '/layout',
    },
    {
        img: formExample,
        title: '样式常量 EXAMPLE & DOC',
        author: 'visionary',
        path: '',
    },
