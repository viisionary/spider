import {FieldType} from "spider-vision/Form/type";
    ...
    },
    {
        ...
        staticOptions: [
            // AAC的时候只能选fltp/ PCMA只能选S16
            {
                label: 'fltp',
                value: '1',
                exclude: [{ id: 'audioCodecType', value: ['2'] }],
            },
            {
                label: 'S16',
                value: '2',
                exclude: [{ id: 'audioCodecType', value: ['1'] }],
            },
        ],
    },
    {
...
export const getMeetingStatusText = (status: string) => {
    // @ts-ignore
